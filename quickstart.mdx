---
title: "Getting Started with Mailblock SDK"
description: "This guide will help you get up and running with the Mailblock SDK in just a few minutes."
---

## Prerequisites

- Node.js 14 or higher
- A Mailblock API key (get one at (Mailblock)[https://mailblock.de])
...
If you're using a custom Mailblock deployment:

```javascript
const client = new Mailblock(
  'your-api-key',
  'https://your-custom-mailblock-instance.com'
);
```
...
```javascript
const client = new Mailblock('your-api-key', undefined, { 
  debug: true 
});
...
- 💬 [GitHub Issues](https://github.com/your-org/mailblock-sdk/issues)
